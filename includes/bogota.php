...
class bogota
{
    ...
    public $pi_bi = array();
    public $pi_pb = array();
    public $pi_Bogotadc = array();
    public $pi_dormir_comer = array();
    public $pi_tarjeta = array();
    public $pi_rld = array();
    public $pi_mice = array();
    ...
    function __construct($language, $development = false)
    {
        ...
        // Palabras Interfaz BI 
        $this->pi_bi = $this->getPalabrazInterfaz(3222);
        // Palabras Interfaz PB 
        $this->pi_pb = $this->getPalabrazInterfaz(3224);
        // Palabras Interfaz Bogotadc.travel ES 
        $this->pi_Bogotadc = $this->getPalabrazInterfaz(3093);
        // Palabras Interfaz Dónde dormir / Dónde comer 
        $this->pi_dormir_comer = $this->getPalabrazInterfaz(3226);
        // Palabras Interfaz Tarjeta Ciudad 
        $this->pi_tarjeta = $this->getPalabrazInterfaz(3227);
        // Palabras Interfaz RLD 
        $this->pi_rld = $this->getPalabrazInterfaz(3225);
        // Palabras Interfaz MICE 
        $this->pi_mice = $this->getPalabrazInterfaz(3223);
    }
    ...
    function blogs($ID, $productID, $quantity = 13, $offset = 0, $page = 1)
    {
        ...
        $result = $this->query("blog/" . $ID . "/" . $productID);
...
function getOfertasBy($atractivo = "all", $localidad="all",$zona = "all", $comercial = "all"){
    $result = $this->query("ofertas_filtradas/".$atractivo."/".$localidad."/".$zona."/".$comercial, "", true);
    return $result;
}
